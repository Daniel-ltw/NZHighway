...
public class LQJExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://argonautltd.co.nz/lrms/4^^lrmsLinear",LQJlrmsLinear.class);
        classNames.put("http://argonautltd.co.nz/lrms/4^^lrmsPoint",LQJlrmsPoint.class);
        classNames.put("http://argonautltd.co.nz/lrms/4^^locateMultiple",LQJlocateMultiple.class);
        classNames.put("http://argonautltd.co.nz/lrms/4^^locateMultipleAlongRoad",LQJlocateMultipleAlongRoad.class);
    }   
    ...
    public LQJExtendedSoapSerializationEnvelope() {
        super(SoapEnvelope.VER11);
        implicitTypes = true;
        setAddAdornments(false);
        new LQJMarshalGuid().register(this);
        new LQJMarshalDate().register(this);
        ...
        if (obj == null || obj== SoapPrimitive.NullNilElement) {
            ...
            if (!type.multiRef && qName[2] == null )
            {
                if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class)) {
                    String xmlName=LQJHelper.getKeyByValue(classNames,obj.getClass());
                    if(xmlName!=null)
                    {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,LQJExtendedSoapSerializationEnvelope.class);
