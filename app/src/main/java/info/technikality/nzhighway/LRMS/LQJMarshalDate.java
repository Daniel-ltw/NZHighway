...
public class LQJMarshalDate implements Marshal
{
    ...
    {
        return LQJHelper.ConvertFromWebService(parser.nextText());
    }
    ...
    {
        writer.text(LQJHelper.getDateFormat().format((Date)obj));
    }
}
